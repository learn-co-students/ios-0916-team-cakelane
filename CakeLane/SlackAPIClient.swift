...
//            print(completeJSON)
    ...
    class func postSlackNotification() {
        ...
        let parameters: [String:Any] = [
            "text": "Fixing MarkDown Flag in Attachment Struct",
            "attachments": [newAttachment.dictionary]
        ]
